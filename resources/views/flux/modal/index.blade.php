...
$classes = Flux::classes()
    ->add(match ($variant) {
        ...
        'flyout' => match($position) {
            ...
            'left' => 'fixed m-0 p-8 max-h-dvh min-h-dvh md:[:where(&)]:min-w-[25rem] overflow-y-auto me-auto ltr:[--fx-flyout-translate:translateX(-50px)] rtl:[--fx-flyout-translate:translateX(50px)] border-e',
            default => 'fixed m-0 p-8 max-h-dvh min-h-dvh md:[:where(&)]:min-w-[25rem] overflow-y-auto ms-auto ltr:[--fx-flyout-translate:translateX(50px)] rtl:[--fx-flyout-translate:translateX(-50px)] border-s',
        },
